...
namespace FlashcardsApp.Models
{
    public class Learn
    {
        ...
        private static Dictionary<int, int> Stage_DaysToRevise = new Dictionary<int, int>
        {
            {0, 4},
            {1, 7},
            {2, 14},
        ...
        private static Dictionary<int, float> Ease_ReviseMulitplier = new Dictionary<int, float>
        {
            {1, 0},
            {2, 0.25f},
            {3, 0.5f},
         ...
         */
        public async Task<List<CardDto>> GetLearningCards(int userId, int deckId, int cardAmount, string connectionString)
        {
         ...
         */
        public async Task<int> EvaluateResult(int userId, int cardId, int deckId, int response, string connectionString)
        {
